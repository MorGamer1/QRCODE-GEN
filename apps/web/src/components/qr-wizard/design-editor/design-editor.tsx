  ...
  return (
    <div className="space-y-6">
      ...
      <section className="space-y-4">
        ...
        <ShapePicker
          name="design.moduleShape"
          label="Module shape"
          options={MODULE_SHAPE_OPTIONS}
        />
        <div className="grid grid-cols-2 gap-4">
          <ShapePicker
            name="design.eyeFrameShape"
            label="Eye frame"
            options={EYE_FRAME_SHAPE_OPTIONS}
          />
          <ShapePicker
            name="design.eyeBallShape"
            label="Eye ball"
      ...
      <section className="space-y-4">
        ...
        <FillPicker
          name="design.backgroundFill"
          label="Background"
          nullable
          nullLabel="Transparent"
        />
        <FillPicker
          name="design.eyeFrameFill"
          label="Eye frame"
          nullable
          nullLabel="Match modules"
        />
        ...
        <div className="space-y-1.5">
          ...
          {hasLogo && (
            <p className="text-xs text-muted-foreground">
              Locked to High while a logo is set, so the code stays scannable.
            </p>
          )}
        </div>
      </section>
