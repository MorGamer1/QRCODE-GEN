...
export default function AdminUsersPage() {
  ...
  const [deleteTarget, setDeleteTarget] = React.useState<{ id: string; email: string } | null>(
    null,
  );
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <Select
          ...
          onValueChange={(v) => setRole(v === ALL_ROLES ? undefined : (v as UserRole))}
        >
              ...
              data?.items.map((user) => {
                ...
                return (
                  <TableRow key={user.id}>
                    ...
                    <TableCell>
                      <Badge variant={user.role === UserRole.USER ? 'secondary' : 'default'}>
                        {user.role.replace('_', ' ')}
                      </Badge>
                    </TableCell>
                    <TableCell>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This permanently deletes the user and all of their QR codes, scan history, and API
              keys. This can&apos;t be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
